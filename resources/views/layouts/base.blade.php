                            ...
                            <li class="menu-item menu-item-has-children parent" >
                                ...
                                @if(\Illuminate\Support\Facades\Auth::user())
                                    @if (\Illuminate\Support\Facades\Auth::user()->uType === 'ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="Dollar (USD)" href="#">My Account({{\Illuminate\Support\Facades\Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                ...
                                                <li class="menu-item">
                                                    <a title="Logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logoutForm').submit()">Logout</a>
                                                </li>
                            ...
                            <a href="#" class="link-direction">
                                ...
                                <div class="left-info">
                                    @if (\Gloudemans\Shoppingcart\Facades\Cart::count()>0)
                                        <span class="index">{{\Gloudemans\Shoppingcart\Facades\Cart::count()}} items</span>
                                    @endif
