                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="product-name">
                            <a class="link-to-product" href="{{route('product_detail',['slug' => $item->model->slug])}}">{{$item->model->name}}</a>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" class="btn btn-delete" wire:click.prevent="deleteFromCart('{{$item->rowId}}')" title="">
