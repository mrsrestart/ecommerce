        ...
        <div class="row">
                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            <ul class="slides">
                                <li data-thumb="{{asset('assets/images/products')}}/{{$product_detail->image}}">
                                    <img src="{{asset('assets/images/products')}}/{{$product_detail->image}}" alt="{{$product_detail->name}}" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="detail-info">
                        ...
                        <div class="wrap-price"><span class="product-price">{{$product_detail->regular_price}}</span></div>
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{$product_detail->Stock}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                        ...
                        <div class="wrap-butons">
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product_detail->id}} ,'{{$product_detail->name}}',{{$product_detail->regular_price}})">Add to Cart</a>
                            <div class="wrap-btn">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content">
                        <ul class="products">
                            @foreach($product_pup as $product)
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product_detail',['slug' => $product->slug]) }}" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$product->image}}" alt="{{$product->name}}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ route('product_detail',['slug' => $product->slug]) }}" class="product-name"><span>{{$product->name}}</span></a>
